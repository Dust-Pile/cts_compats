...
public class PVJRegistry {
    ...
    public static final PVJRegistry INSTANCE = new PVJRegistry();
    PVJRegistry () {}

    private static final DeferredRegister<Block> COMPAT_BLOCKS = DeferredRegister.create( ForgeRegistries.BLOCKS, MODID );

    public static final RegistryObject<Block> SHORTER_GRASS_ON_TOP = register("shorter_grass_on_top",
    ...
    private static RegistryObject<Block> register( String name, Block block ) {
        return COMPAT_BLOCKS.register( name, () -> { return block; });
    }
